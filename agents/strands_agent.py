...
mcp_url = get_agent_core_runtime_url(AGENT_ARN, AWS_REGION)
...
with mcp_client:
    ...
    response = agent(prompt="Hello, Im Luke. Please get my canvas name. If there are some issues, please show me as log.")
